...
$languageStrings = array(
    'RelatedBlocksLists' => 'Связанные блоки и списки',
    'LBL_MODULE' => 'Модуль',
    'LBL_RELATED_MODULE' => 'Связанные модуль',
    'LBL_ENABLE_MODULE' => 'Активировать модуль',
    'LBL_FIELDS' => 'Поля',
    'LBL_BLOCK' => 'Блок',
    'LBL_LIST' => 'Список',
    'LBL_RELATED' => 'Связанный',
    'LBL_ACTIVE' => 'Активный',
    'LBL_INACTIVE' => 'Неактивный',
    'LBL_STATUS' => 'Статус',
    'LBL_VIEW' => 'Просмотр',
    'LBL_ADD_MORE' => 'Добавить ещё',
    'LBL_ADD_AFTER' => 'Добавить после',
    'LBL_CREATE_ANOTHER' => 'Создать другую запись',

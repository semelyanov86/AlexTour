...
$languageStrings = array(
    'RelatedRecordUpdate' => 'Related Record Update',
    'LBL_ENABLE_MODULE' => 'Enable Related Record Update',
...
//    'LBL_ADD_FIELDS_TO_UPDATE' => '',
    ...
    'MODULE_LBL' => 'Related Record Update',
    ...
    'LBL_TARGET_TO' => 'TARGET(TO)',
    'LBL_INFO' => 'Info',
    'LBL_INFO_TEXT' => '<b>Source</b> field value will be used to update <b>target</b> field.<br /><br />Example:<br /><br />SOURCE(FROM) = Contact Mailing Address<br />TARGET(TO) = Organization Billing Address<br /><br />When workflow conditions are met, organization\'s billing address will get updated with contact\'s mailing address.',
    /* For License page - End */
    'LBL_INFO_BLOCK'=>'Info',
    'LBL_INFO_BLOCK_ON_SETTING_PAGE'=>'Related Record Update Workflow Tasks have to be creating using workflows. Please go to Automation > Workflows, create new/edit existing workflow and you see under "Add Tasks" - there will be new option for "Related Record Update (Workflow Task)".<br /><br />NOTE: Please refer to the extension user guide for more details. User guide includes detailed explanation of how the extension.',
);

...
$languageStrings = array(
    ...
    'LBL_INFO_BLOCK'=>'Info',
    'LBL_INFO_BLOCK_ON_SETTING_PAGE'=>'No configuration is needed. Export to XLS option has been added to every list in the system. Open the list of records, click More > Export to XLS.',
);

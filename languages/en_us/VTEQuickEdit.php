...
$languageStrings = array(
    'VTEQuickEdit' => 'VTE Quick Edit',
    'No linked record!' => 'No linked record!',
    'LBL_STATUS' => 'Enable VTE Quick Edit',

    /* For License page - Begin */
    'MODULE_LBL' => 'VTE Quick Edit',
    ...
    'LBL_INFO_BLOCK'=>'Info',
    'LBL_INFO_BLOCK_ON_SETTING_PAGE'=>'No configuration is needed. Edit (pencil icon) will automatically show up on all the related fields on all modules.',
);

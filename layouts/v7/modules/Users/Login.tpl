        ...
        <div style="margin-left: -10px">
                    ...
                    <ul class="bxslider">
                        <li>
                                <div id="slide0" class="slide">
                                    <img class="pull-left" src="test/logo/pig.png">
                                </div>
                            </li><li>
                                <div id="slide1" class="slide">
                                    <img class="pull-left" src="test/logo/Information-Technology.png">
                                </div>
                            </li>
                    </ul>
                </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 login-area">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 site-info">
                    <h1 class="login-header">AL.EX Reiseservice</h1>
                    <p>VtigerCRM Kundenverwaltungssystem</p>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 login-more-info vte-user-login">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 social">
                            <a class="social" target="_blank" href="https://www.facebook.com/pages/ALEX-Reiseservice/150357925021371">
                                            <i class="icon-social-facebook icons"></i>
                                        </a><a class="social" target="_blank" href="https://twitter.com/ALEX_ReisenDE">
                                            <i class="icon-social-twitter icons"></i>
                                        </a><a class="social" target="_blank" href="https://www.youtube.com/channel/UCb6nfpF2D-ZSr2Qx517TjHQ">

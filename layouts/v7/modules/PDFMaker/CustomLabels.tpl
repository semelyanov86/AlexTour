        ...
        <div class="row-fluid">
            ...
            <div class="row-fluid">
                <div class="pull-right btn-group">
                    <button type="button" class="addCustomLabel btn addButton btn-default" data-url="?module=PDFMaker&view=IndexAjax&mode=editCustomLabel"><i class="icon-plus icon-white"></i>&nbsp;<strong> {vtranslate('LBL_ADD')}</strong></button>
                        ...
                        <td style="border-right: 0px;">
                            ...
                            <div class="pull-right actions">
                                ...
                                <a class="deleteCustomLabel cursorPointer" data-url="?module=PDFMaker&action=IndexAjax&mode=deleteCustomLabel&labelid={$label_id}">
                                    <i title="{vtranslate('LBL_DELETE','PDFMaker')}" class="fa fa-trash"></i></a>&nbsp;
                            </div>
                        </td>
                        <td>
            ...
            <div class="row-fluid pushDownHalfper">
                <div class="pull-right btn-group">
                    <button type="button" class="addCustomLabel btn addButton btn-default" data-url="?module=PDFMaker&view=IndexAjax&mode=editCustomLabel"><i class="icon-plus icon-white"></i>&nbsp;<strong> {vtranslate('LBL_ADD')}</strong></button>
                    <button type="reset" class="btn btn-default marginLeftZero" onClick="window.history.back();">{vtranslate('LBL_CANCEL')}</button>
                </div>
            </div>
        </div>
    </form>

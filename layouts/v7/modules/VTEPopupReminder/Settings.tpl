...
<div class="container-fluid">
    <div class="widget_header row-fluid">
        <h3>{vtranslate('VTEPopupReminder', $QUALIFIED_MODULE)}</h3>
    </div>
    <hr>
    <div class="clearfix"></div>
    <div class="summaryWidgetContainer">
        <div class="row-fluid">
            <h4>{vtranslate('LBL_ENABLE_MODULE', $QUALIFIED_MODULE)}&nbsp;&nbsp;<input type="checkbox" name="enable_module" id="enable_module" value="1" {if $ENABLE eq '1'}checked="" {/if}/></h4>
        </div>
    </div>
    <div class="clearfix"></div>
    <div>

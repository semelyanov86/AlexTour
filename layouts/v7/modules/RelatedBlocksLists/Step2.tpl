        ...
        <form name="EditWorkflow" action="index.php" method="post" id="installation_step2" class="form-horizontal">
            ...
            <div class="padding1per" style="border:1px solid #ccc; padding: 10px;">
                ...
                <div class="control-group" style="margin-bottom:10px;">
                    ...
                    <div class="controls"><input type="text" id="license_key" name="license_key" value="" data-validation-engine="validate[required]" class="col-lg-8" name="summary"></div>
                </div>
                <div class="clearfix"></div>
                {if $VTELICENSE->result eq 'bad' || $VTELICENSE->result eq 'invalid'}
                    <div class="text text-danger" id="error_message">
                        {$VTELICENSE->message}
                    </div>
                {/if}

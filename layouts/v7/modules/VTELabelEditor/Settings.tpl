                        ...
                        <div class="col-sm-12 col-xs-12">
                            <div class="row">
                                ...
                                <div class="col-sm-5 col-xs-5 label-editor-info">
                                    ...
                                    <span>
                                        <p>To edit the label, select language, module/file and the available labels will show up. You can also search for certain word e.g "Add Contact" and it will show all files that consist that label - you can then select the file and change the label.</p>

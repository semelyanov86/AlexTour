...
var VDSimplyKPI_Edit2_Js = {
    ...
    initialize : function(container) {
        if(typeof container == 'undefined') {
            container = jQuery('#VDSimplyKPI_step2');
        }
        if(container.is('#VDSimplyKPI_step2')) {
            this.setContainer(container);
        }else{
            this.setContainer(jQuery('#VDSimplyKPI_step2'));
        }
    ...
    registerSelectColunmNameValue: function(){
        ...
        jQuery('#VDSimplyKPI_step2').on('click','.deleteCondition',function(e) {
        ...
        form_step2.on('submit',function(e){
            ...
            app.request.post({data:formData}).then(
                function(err,data){
                    if(err === null) {
                        if(data) {
                            app.helper.showSuccessNotification({message : app.vtranslate('Conditional Layouts had been saved successfully')});
                            ...
                            app.request.post({'data':params}).then(function(err,data) {
                                ...
                                var jsStep3Instance = new VDSimplyKPI_Edit3_Js();
        ...
        container.on('click','.backStep',function(e){
            ...
            app.request.post({'data':actionParams}).then(
                function(data) {
                    if(data) {
                        jQuery('.installationContents').html(data);
                        var jsStep1Instance = new VDSimplyKPI_Edit_Js();

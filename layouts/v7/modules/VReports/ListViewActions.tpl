    ...
    <div id="listview-actions" class="listview-actions-container">
        ...
        <div class = "row">
            ...
            <div class='col-md-2'>
                ...
                {*{elseif $WARNINGS>0 && $ERROR_NUM>0}*}
                    <td style="padding-left: 5px;"><button id="phpiniWarnings" name="phpiniWarnings" class="btn btn-danger" style="margin-right:5px;">{vtranslate('LBL_FIND_ERROR', $MODULE)}</button></td>
                {*{/if}*}
            </div>
            <div class="col-md-3">

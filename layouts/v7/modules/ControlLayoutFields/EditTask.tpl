...
{/literal}
{strip}
    <div class='modal-dialog modal-lg clf-container' id="addTaskContainer">
        ...
        <form class="form-horizontal" id="saveTask" method="post" action="index.php">
            ...
            <div id="scrollContainer">
                <div class="modal-body tabbable">
                    <div class="row clf-padding-top">
						<span class="col-lg-8 row">
							<div class="col-lg-2">{vtranslate('LBL_TASK_TITLE',$QUALIFIED_MODULE)}<span class="redColor">*</span></div>
							<div class="col-lg-9 row">
                                <input name="name" class="form-control" type="text" value="{$TASK_INFO['name']}" />
                            </div>
						</span>
						<span class="col-lg-4 row hide">
							<div class="col-lg-3">{vtranslate('LBL_STATUS',$QUALIFIED_MODULE)}</div>
							<div class="col-lg-8">
                    ...
                    <div class="taskTypeUi row well">
                        <span class="col-lg-8">
                            <div>
                                <strong>Set Field Values</strong>
                            </div>
                        </span>
                        <span class="col-lg-10 clf-container">
                            {foreach from=$TASK_INFO['actions'] item=ACTION}
                                <div class="option-row clf-padding-top row">
                                        <span class="col-lg-5 useFieldContainer">
                                            <span name="{$SELECTED_MODULE_MODEL->get('name')}" class="useFieldElement">
                                                ...
                                                <select class="useField clfcb select2" data-placeholder="{vtranslate('LBL_USE_FIELD',$QUALIFIED_MODULE)}" style="min-width: 250px;">
                                        ...
                                        <span class="fieldUiHolder col-lg-6">
                                            <select class="fieldOption clfcb select2" style="min-width: 220px;">
                                        ...
                                        <i class="delTask deleteCondition glyphicon glyphicon-trash"></i>
                                        </span>
                                </div>
                                <br>
                            {/foreach}
                        ...
                        <div class="row col-lg-12">
                            <button class="btn btn-default addClfFieldBtn" type="button">Add Field</button>
                        </div>
                        <div class="basicAddFieldContainer hide clf-padding-top row">
                            <span class="col-lg-5 useFieldContainer">
                                <span name="{$SELECTED_MODULE_MODEL->get('name')}" class="useFieldElement">
                                    {assign var=MODULE_FIELDS value=$SELECTED_MODULE_MODEL->getFields()}

...
<div class="listViewPageDiv">
	<div class="listViewTopMenuDiv">
		...
		<div class="row">
			<span class="col-lg-4">
				<button class="btn addButton" onclick='window.location.href="index.php?module=ControlLayoutFields&parent=Settings&view=Edit"'>
			...
			<span class="col-lg-4">
				{include file='ListViewActions.tpl'|vtemplate_path:'ControlLayoutFields'}
			</span>
		</div>
		<div class="clearfix"></div>
	</div>

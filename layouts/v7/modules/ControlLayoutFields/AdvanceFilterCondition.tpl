...
<div class="row conditionRow marginBottom10px">
	...
	<span class="col-lg-4 fieldUiHolder">
		<input name="{if $SELECTED_FIELD_MODEL}{$SELECTED_FIELD_MODEL->get('name')}{/if}" data-value="value" class="inputElement col-lg-12 form-control" type="text" value="{$CONDITION_INFO['value']}" />
	</span>
	<span class="hide">

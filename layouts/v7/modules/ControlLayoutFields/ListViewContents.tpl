...
<div class="listViewEntriesDiv contents-bottomscroll" style="padding-top: 10px;">
	...
	<table class="table table-bordered listViewEntriesTable">
		...
		<tr class="listViewEntries" data-id='{$LISTVIEW_ENTRY['id']}' data-recordUrl='index.php?module=ControlLayoutFields&parent=Settings&view=Edit&record={$LISTVIEW_ENTRY['id']}' id="{$MODULE}_listView_row_{$smarty.foreach.listview.index+1}">
            ...
            <td class="medium" nowrap="">
                <div class="actions" style="text-align: center;">
                    <span class="actionImages">
                       <a href="index.php?module=ControlLayoutFields&parent=Settings&view=Edit&record={$LISTVIEW_ENTRY['id']}">

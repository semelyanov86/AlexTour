            ...
            {* SalesPlatform.ru end *}
				<div id="appnav" class="navbar-right">
					<ul class="nav navbar-nav">
						<li><button id="importFromCSV" type="button" class="btn btn-outline module-buttons" onclick="sendFile()">
								<div class="fa fa-book"></div>&nbsp;&nbsp;
								{vtranslate('Import from CSV', $MODULE)}
							</button>
						</li>
			...
			app.request.post({data: params}).then(
					function (err, data) {
						if (err === null) {
                            ...
                            VTEPayments_List_Js.validateSendFilePage();
						}
					}
			);
		}

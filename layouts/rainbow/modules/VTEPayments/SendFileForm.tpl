    ...
    <div id="sendMessageContainer" class='modal-dialog modal-lg'>
        <div class="modal-content">
            <form class="form-horizontal" id="massSave" method="POST" action="index.php" enctype="multipart/form-data">
                {assign var=HEADER_TITLE value={vtranslate('Send CSV File', $MODULE)}|cat:" "|cat:{vtranslate($SINGLE_MODULE, $MODULE)}}
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-body tabbable">
                        ...
                        <hr>
                        <div>
                            <span><strong>{vtranslate('Choose bank',$MODULE)}</strong></span>
                        </div>
                        <div class="form-group">
                            {include file=vtemplate_path($FIELD_MODEL->getUITypeModel()->getTemplateName(),$MODULE)}
                        </div>
                        <div>
                            <span><strong>{vtranslate('Choose CSV',$MODULE)}</strong></span>
                        </div>
                        <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    {/if}
                    <input id="sendFile" type="submit" class="btn btn-success" value="Send File" />

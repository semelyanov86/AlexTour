					...
					<div class="row entry clearfix">
						<div class='col-lg-2 col-xs-3 pull-left'>
							...
							{assign var=iconsarray value=['potentials'=>'attach_money','marketing'=>'thumb_up','leads'=>'thumb_up','accounts'=>'business',
									...
									'mycthemeswitcher'=>'folder', 'chat'=>'chat', 'mobilecall'=>'call', 'call'=>'call', 'meeting'=>'people', 'tours' => 'card_travel', 'flights' => 'flight_takeoff', 'tourprices' => 'insert_chart', 'airports' => 'flight', 'tourservices' => 'room_service', 'hotels' => 'hotel', 'cities' => 'location_city', 'vtepayments' => 'payment', 'packageservices' => 'shop', 'movings' => 'flight_land', 'discounts' => 'trending_down', 'servicerequests' => 'add_shopping_cart', 'countries' => 'public', 'airlines' => 'router', 'servicedetails' => 'book', 'hotelprices' => 'local_atm', 'hotelarrivals' => 'local_activity', 'visa' => 'nfc' ]}

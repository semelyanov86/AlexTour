<?php /* Smarty version Smarty-3.1.7, created on 2019-04-10 11:28:15
         compiled from "/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Settings/CronTasks/EditAjax.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19954107285cada91fa24091-96471158%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '19954107285cada91fa24091-96471158',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cada91fa9e09',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cada91fa9e09')) {function content_5cada91fa9e09($_smarty_tpl) {?>
...
</option></select></div></div><div class="form-group" style="text-align: center;"><div class="col-xs-2"></div><div class="col-xs-8"><?php if ($_smarty_tpl->tpl_vars['RECORD_MODEL']->value->get('description')){?><div class="alert alert-info"><?php echo vtranslate($_smarty_tpl->tpl_vars['RECORD_MODEL']->value->get('description'),$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</div><?php }?></div></div></div><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path('ModalFooter.tpl',$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
</form></div></div>	
<?php }} ?>
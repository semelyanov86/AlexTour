<?php /* Smarty version Smarty-3.1.7, created on 2019-06-01 19:19:51
         compiled from "/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Visa/DetailViewBlockView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:34579405cadc841b0ebd6-92934928%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f76a8ef062a5e8892df3c9b62c355ce25f5e72cb' => 
    array (
      0 => '/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Visa/DetailViewBlockView.tpl',
      1 => 1556124980,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '34579405cadc841b0ebd6-92934928',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5cadc841ba833',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_5cadc841ba833')) {function content_5cadc841ba833($_smarty_tpl) {?>
...
<?php }?><?php if (($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=='72')&&($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName()=='unit_price')){?>(<?php echo $_smarty_tpl->tpl_vars['BASE_CURRENCY_SYMBOL']->value;?>
 ...
 <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMobilePhoneField()){?> spMobilePhone <?php }?>" <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName()==='cf_1157'||$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName()==='description'){?>style="border: 1px solid cornflowerblue; width: 200px; height: 30px; padding-top: 5px; padding-left:5px; "<?php }?> id="<?php echo $_smarty_tpl->tpl_vars['MODULE_NAME']->value;?>

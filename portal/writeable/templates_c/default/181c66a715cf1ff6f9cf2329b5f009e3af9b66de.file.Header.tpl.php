<?php /* Smarty version Smarty-3.1.19, created on 2019-11-12 11:48:33
         compiled from "/var/www/www-root/data/www/avelacom.vordoom.ru/portal/layouts/default/templates/Header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7376431825d9c42217c2880-36471843%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '181c66a715cf1ff6f9cf2329b5f009e3af9b66de' => 
    array (
      0 => '/var/www/www-root/data/www/avelacom.vordoom.ru/portal/layouts/default/templates/Header.tpl',
      1 => 1573552111,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7376431825d9c42217c2880-36471843',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5d9c422182bb89_78300380',
  'variables' => 
  array (
    'MODULE' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_5d9c422182bb89_78300380')) {function content_5d9c422182bb89_78300380($_smarty_tpl) {?>
				...
				<div class="col-lg-8 col-md-8 col-sm-6 col-xs-6 portalnavbar" ng-if="loginUser">
					<ul class=" nav navbar-nav headerLinks menu" ng-show="modules">
						...
						<li class="hidden-xs hidden-sm hidden-md visible-lg" ng-repeat="module in modules|orderModulesBy:'order'" ng-if="module!=='language' && module.name!=='ProjectTask' && module.name!=='ProjectMilestone'" ng-class="{'active':isActive(module.name)}">
							<a ng-if="$index >1  && $index <=8" translate="{{module.uiLabel}}" href="index.php?module={{module.name}}">{{module.uiLabel}}</a>
						</li>
						<li class="hidden-xs navbartoggle" ng-if="modulesCount > 9">
							...
							<ul class="dropdown-menu">
								...
								<li ng-repeat="module in modules|orderModulesBy:'order'" ng-if="module!=='language' && module.name!=='ProjectTask' && module.name!=='ProjectMilestone'" ng-class="{'active':isActive(module.name)}">
									<a ng-if="$index > 8" translate="{{module.uiLabel}}" href="index.php?module={{module.name}}">{{module.uiLabel}}</a>
								</li>
							</ul>
						</li>
						<li>

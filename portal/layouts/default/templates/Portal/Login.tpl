                        ...
                        <form class="form-horizontal" novalidate="novalidate" ng-submit="makeAutoComplete();login(loginForm.$valid)" name="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <!-- SalesPlatform.ru begin --><!-- <span class="text-danger" ng-if="loginForm.username.$error.pattern">Please enter a valid email address.</span> --><span class="text-danger" translate="Please enter a valid email address" ng-if="loginForm.username.$error.pattern">Please enter a valid email address.</span>{/literal}<!-- SalesPlatform.ru end -->
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group" ng-if="loginFailed && !loginForm.username.$error.pattern">
                                ...
                                {literal}<!-- SalesPlatform.ru begin --><!-- <div class="col-sm-8 text-danger">{{loginMessage}}</div>--><div class="col-sm-8 text-danger">{{loginMessage | translate}}</div>{/literal}
                            </div>

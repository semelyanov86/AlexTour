...
/**
 * Class ServiceDetails_Uninstall_View
 */
class ServiceDetails_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_servicedetailscf table
        echo "&nbsp;&nbsp;- Delete vtiger_servicedetailscf table.";
        $result = $adb->pquery("DROP TABLE vtiger_servicedetailscf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_servicedetails table
        echo "&nbsp;&nbsp;- Delete vtiger_servicedetails table.";
        $result = $adb->pquery("DROP TABLE vtiger_servicedetails");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }

...
class ServiceDetails extends Vtiger_CRMEntity {
    var $db;
	var $table_name = 'vtiger_servicedetails';
	var $table_index= 'servicedetailsid';
	var $related_tables = Array ('vtiger_servicedetailscf' => Array ( 'servicedetailsid', 'vtiger_servicedetails', 'servicedetailsid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_servicedetailscf', 'servicedetailsid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_servicedetails', 'vtiger_servicedetailscf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_servicedetails' => 'servicedetailsid',
		'vtiger_servicedetailscf'=>'servicedetailsid');
	...
	var $list_fields = Array (
		...
		'Name' => Array('servicedetails', 'name'),
	...
	*/
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_servicedetails, vtiger_users,
                ...
                vtiger_servicedetails.servicedetailsid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_servicedetails.servicedetailsid = $id AND

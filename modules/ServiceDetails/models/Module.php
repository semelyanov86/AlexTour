...
/**
 * Class ServiceDetails_Module_Model
 */
class ServiceDetails_Module_Model extends Vtiger_Module_Model
{
    /**
     * @return array
     */
    function getSettingLinks()
    {
        ...
        $settingsLinks[] = array(
            ...
            'linklabel' => 'Uninstall',
            'linkurl' => 'index.php?module=ServiceDetails&parent=Settings&view=Uninstall',
            'linkicon' => ''
        );

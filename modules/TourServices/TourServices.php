...
class TourServices extends Vtiger_CRMEntity {
    var $db;
	var $table_name = 'vtiger_tourservices';
	var $table_index= 'tourservicesid';
	var $related_tables = Array ('vtiger_tourservicescf' => Array ( 'tourservicesid', 'vtiger_tourservices', 'tourservicesid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_tourservicescf', 'tourservicesid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_tourservices', 'vtiger_tourservicescf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_tourservices' => 'tourservicesid',
		'vtiger_tourservicescf'=>'tourservicesid');
	...
	*/
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_tourservices, vtiger_users,
                ...
                vtiger_tourservices.tourservicesid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_tourservices.tourservicesid = $id AND

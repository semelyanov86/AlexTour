...
/**
 * Class TourServices_Uninstall_View
 */
class TourServices_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_tourservicescf table
        echo "&nbsp;&nbsp;- Delete vtiger_tourservicescf table.";
        $result = $adb->pquery("DROP TABLE vtiger_tourservicescf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_tourservices table
        echo "&nbsp;&nbsp;- Delete vtiger_tourservices table.";
        $result = $adb->pquery("DROP TABLE vtiger_tourservices");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }

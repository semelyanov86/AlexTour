...
/**
 * Class TourServices_Module_Model
 */
class TourServices_Module_Model extends Vtiger_Module_Model
{
    /**
     * @return array
     */
    function getSettingLinks()
    {
        ...
        $settingsLinks[] = array(
            ...
            'linklabel' => 'Uninstall',
            'linkurl' => 'index.php?module=TourServices&parent=Settings&view=Uninstall',
            'linkicon' => ''
        );

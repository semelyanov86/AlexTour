...
/**
 * Class HotelPrices_Uninstall_View
 */
class HotelPrices_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_hotelpricescf table
        echo "&nbsp;&nbsp;- Delete vtiger_hotelpricescf table.";
        $result = $adb->pquery("DROP TABLE vtiger_hotelpricescf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_hotelprices table
        echo "&nbsp;&nbsp;- Delete vtiger_hotelprices table.";
        $result = $adb->pquery("DROP TABLE vtiger_hotelprices");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }

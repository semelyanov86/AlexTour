...
class HotelPrices extends Vtiger_CRMEntity {
    var $db;
	var $table_name = 'vtiger_hotelprices';
	var $table_index= 'hotelpricesid';
	var $related_tables = Array ('vtiger_hotelpricescf' => Array ( 'hotelpricesid', 'vtiger_hotelprices', 'hotelpricesid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_hotelpricescf', 'hotelpricesid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_hotelprices', 'vtiger_hotelpricescf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_hotelprices' => 'hotelpricesid',
		'vtiger_hotelpricescf'=>'hotelpricesid');
	...
	*/
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_hotelprices, vtiger_users,
                ...
                vtiger_hotelprices.hotelpricesid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_hotelprices.hotelpricesid = $id AND

...
/**
 * Class HotelPrices_Module_Model
 */
class HotelPrices_Module_Model extends Vtiger_Module_Model
{
    /**
     * @return array
     */
    function getSettingLinks()
    {
        ...
        $settingsLinks[] = array(
            ...
            'linklabel' => 'Uninstall',
            'linkurl' => 'index.php?module=HotelPrices&parent=Settings&view=Uninstall',
            'linkicon' => ''
        );

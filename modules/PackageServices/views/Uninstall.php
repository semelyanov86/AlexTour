...
/**
 * Class PackageServices_Uninstall_View
 */
class PackageServices_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_packageservicescf table
        echo "&nbsp;&nbsp;- Delete vtiger_packageservicescf table.";
        $result = $adb->pquery("DROP TABLE vtiger_packageservicescf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_packageservices table
        echo "&nbsp;&nbsp;- Delete vtiger_packageservices table.";
        $result = $adb->pquery("DROP TABLE vtiger_packageservices");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }

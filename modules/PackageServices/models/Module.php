...
/**
 * Class PackageServices_Module_Model
 */
class PackageServices_Module_Model extends Vtiger_Module_Model
{
    /**
     * @return array
     */
    function getSettingLinks()
    {
        ...
        $settingsLinks[] = array(
            ...
            'linklabel' => 'Uninstall',
            'linkurl' => 'index.php?module=PackageServices&parent=Settings&view=Uninstall',
            'linkicon' => ''
        );

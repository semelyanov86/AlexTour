...
class PackageServices extends Vtiger_CRMEntity {
    var $db;
	var $table_name = 'vtiger_packageservices';
	var $table_index= 'packageservicesid';
	var $related_tables = Array ('vtiger_packageservicescf' => Array ( 'packageservicesid', 'vtiger_packageservices', 'packageservicesid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_packageservicescf', 'packageservicesid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_packageservices', 'vtiger_packageservicescf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_packageservices' => 'packageservicesid',
		'vtiger_packageservicescf'=>'packageservicesid');
	...
	var $list_fields = Array (
		...
		'Name' => Array('packageservices', 'name'),
	...
	*/
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_packageservices, vtiger_users,
                ...
                vtiger_packageservices.packageservicesid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_packageservices.packageservicesid = $id AND

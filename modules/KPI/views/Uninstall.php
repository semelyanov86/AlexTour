...
/**
 * Class KPI_Uninstall_View
 */
class KPI_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_kpicf table
        echo "&nbsp;&nbsp;- Delete vtiger_kpicf table.";
        $result = $adb->pquery("DROP TABLE vtiger_kpicf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_kpi table
        echo "&nbsp;&nbsp;- Delete vtiger_kpi table.";
        $result = $adb->pquery("DROP TABLE vtiger_kpi");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }

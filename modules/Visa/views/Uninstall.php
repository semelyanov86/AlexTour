...
/**
 * Class Visa_Uninstall_View
 */
class Visa_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_visacf table
        echo "&nbsp;&nbsp;- Delete vtiger_visacf table.";
        $result = $adb->pquery("DROP TABLE vtiger_visacf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_visa table
        echo "&nbsp;&nbsp;- Delete vtiger_visa table.";
        $result = $adb->pquery("DROP TABLE vtiger_visa");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }

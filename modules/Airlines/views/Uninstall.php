...
/**
 * Class Airlines_Uninstall_View
 */
class Airlines_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_airlinescf table
        echo "&nbsp;&nbsp;- Delete vtiger_airlinescf table.";
        $result = $adb->pquery("DROP TABLE vtiger_airlinescf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_airlines table
        echo "&nbsp;&nbsp;- Delete vtiger_airlines table.";
        $result = $adb->pquery("DROP TABLE vtiger_airlines");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }

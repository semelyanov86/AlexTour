...
class Airlines extends Vtiger_CRMEntity {
    var $db;
	var $table_name = 'vtiger_airlines';
	var $table_index= 'airlinesid';
	var $related_tables = Array ('vtiger_airlinescf' => Array ( 'airlinesid', 'vtiger_airlines', 'airlinesid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_airlinescf', 'airlinesid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_airlines', 'vtiger_airlinescf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_airlines' => 'airlinesid',
		'vtiger_airlinescf'=>'airlinesid');
	...
	*/
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_airlines, vtiger_users,
                ...
                vtiger_airlines.airlinesid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_airlines.airlinesid = $id AND

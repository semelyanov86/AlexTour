...
/**
 * Class Airports_Uninstall_View
 */
class Airports_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_airportscf table
        echo "&nbsp;&nbsp;- Delete vtiger_airportscf table.";
        $result = $adb->pquery("DROP TABLE vtiger_airportscf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_airports table
        echo "&nbsp;&nbsp;- Delete vtiger_airports table.";
        $result = $adb->pquery("DROP TABLE vtiger_airports");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }

...
class Airports extends Vtiger_CRMEntity {
    var $db;
	var $table_name = 'vtiger_airports';
	var $table_index= 'airportsid';
	var $related_tables = Array ('vtiger_airportscf' => Array ( 'airportsid', 'vtiger_airports', 'airportsid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_airportscf', 'airportsid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_airports', 'vtiger_airportscf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_airports' => 'airportsid',
		'vtiger_airportscf'=>'airportsid');
	...
	*/
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_airports, vtiger_users,
                ...
                vtiger_airports.airportsid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_airports.airportsid = $id AND

...
class EMAILMaker_UninstallEMAILMaker_Action extends Settings_Vtiger_Basic_Action {
    ...
    function process(Vtiger_Request $request){
        ...
        if ($module) {
            ...
            $request->set('key', $EMAILMakerModel->GetLicenseKey());
            
            $EMAILMaker_License_Action_Model = new EMAILMaker_License_Action();
            $EMAILMaker_License_Action_Model->deactivateLicense($request);

...
// ******************************************   Company and User information: **********************************
        ...
        //$Acc_Info = array('' => vtranslate("LBL_PLS_SELECT",'EMAILMaker'));
        ...
        if (getTabId('MultiCompany4you') && vtlib_isModuleActive('MultiCompany4you')){
            $MultiAcc_info = Array('' => vtranslate("LBL_PLS_SELECT",'EMAILMaker'),
                "multicompany-companyname" => vtranslate("LBL_COMPANY_NAME", 'MultiCompany4you'),
                "multicompany-street" => vtranslate("Street", 'MultiCompany4you'),
                "multicompany-city" => vtranslate("City", 'MultiCompany4you'),
                "multicompany-code" => vtranslate("Code", 'MultiCompany4you'),
                "multicompany-state" => vtranslate("State", 'MultiCompany4you'),
                "multicompany-country" => vtranslate("Country", 'MultiCompany4you'),
                "multicompany-phone" => vtranslate("phone", 'MultiCompany4you'),
                "multicompany-fax" => vtranslate("Fax", 'MultiCompany4you'),
                "multicompany-email" => vtranslate("email", 'MultiCompany4you'),
                "multicompany-website" => vtranslate("Website", 'MultiCompany4you'),
                "multicompany-logo" => vtranslate("Logo", 'MultiCompany4you'),
                "multicompany-stamp" => vtranslate("Stamp", 'MultiCompany4you'),
                "multicompany-bankname" => vtranslate("BankName", 'MultiCompany4you'),
                "multicompany-bankaccountno" => vtranslate("BankAccountNo", 'MultiCompany4you'),
                "multicompany-iban" => vtranslate("IBAN", 'MultiCompany4you'),
                "multicompany-swift" => vtranslate("SWIFT", 'MultiCompany4you'),
                "multicompany-registrationno" => vtranslate("RegistrationNo", 'MultiCompany4you'),
                "multicompany-vatno" => vtranslate("VATNo", 'MultiCompany4you'),
                "multicompany-taxid" => vtranslate("TaxId", 'MultiCompany4you'),
                "multicompany-additionalinformations" => vtranslate("AdditionalInformations", 'MultiCompany4you'),
            );
...
// ****************************************** END: Company and User information **********************************
        ...
        $Invterandcon = array("" => vtranslate("LBL_PLS_SELECT",'EMAILMaker'),
...
//custom functions
        ...
        $dateVariables = array("##DD.MM.YYYY##" => vtranslate("LBL_DATE_DD.MM.YYYY",'EMAILMaker'),
        ...
        //if (!$theme_mode){
            ...
            $sharing_types = Array("public" => vtranslate("PUBLIC_FILTER",'EMAILMaker'),
            ...
            if ($num_rows_dec > 0) {
                ...
                $Decimals = array("point" => $settingsResult["decimal_point"],
            ...
            foreach (array('VAT', 'CHARGES') AS $blockType) {
                ...
                $ListView_Block = array("" => vtranslate("LBL_PLS_SELECT",'EMAILMaker'),

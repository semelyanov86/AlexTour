    ...
    function vtlib_handler($modulename, $event_type) {
        switch ($event_type) {
            ...
            case 'module.postupdate':
                $this->db->pquery("UPDATE vtiger_links SET linkurl = ? WHERE linklabel = ? AND linktype = ? AND linkurl = ?",array('layouts/v7/modules/EMAILMaker/resources/EMAILMakerActions.js', 'EMAILMakerJS', 'HEADERSCRIPT', 'modules/EMAILMaker/EMAILMakerActions.js'));
                $this->db->pquery("UPDATE vtiger_links SET linkurl = ? WHERE linklabel = ? AND linktype = ? AND linkurl = ?",array('layouts/v7/modules/EMAILMaker/resources/EMAILMakerActions.js', 'EMAILMakerJS', 'HEADERSCRIPT', 'layouts/vlayout/modules/EMAILMaker/resources/EMAILMakerActions.js'));

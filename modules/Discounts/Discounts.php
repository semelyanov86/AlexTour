...
class Discounts extends Vtiger_CRMEntity {
    var $db;
	var $table_name = 'vtiger_discounts';
	var $table_index= 'discountsid';
	var $related_tables = Array ('vtiger_discountscf' => Array ( 'discountsid', 'vtiger_discounts', 'discountsid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_discountscf', 'discountsid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_discounts', 'vtiger_discountscf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_discounts' => 'discountsid',
		'vtiger_discountscf'=>'discountsid');
	...
	*/
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_discounts, vtiger_users,
                ...
                vtiger_discounts.discountsid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_discounts.discountsid = $id AND

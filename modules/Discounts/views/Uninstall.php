...
/**
 * Class Discounts_Uninstall_View
 */
class Discounts_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_discountscf table
        echo "&nbsp;&nbsp;- Delete vtiger_discountscf table.";
        $result = $adb->pquery("DROP TABLE vtiger_discountscf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_discounts table
        echo "&nbsp;&nbsp;- Delete vtiger_discounts table.";
        $result = $adb->pquery("DROP TABLE vtiger_discounts");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }

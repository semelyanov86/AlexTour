...
/**
 * Class Tours_Uninstall_View
 */
class Tours_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_tourscf table
        echo "&nbsp;&nbsp;- Delete vtiger_tourscf table.";
        $result = $adb->pquery("DROP TABLE vtiger_tourscf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_tours table
        echo "&nbsp;&nbsp;- Delete vtiger_tours table.";
        $result = $adb->pquery("DROP TABLE vtiger_tours");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }

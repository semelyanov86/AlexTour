...
class Tours extends Vtiger_CRMEntity {
    var $db;
	var $table_name = 'vtiger_tours';
	var $table_index= 'toursid';
	var $related_tables = Array ('vtiger_tourscf' => Array ( 'toursid', 'vtiger_tours', 'toursid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_tourscf', 'toursid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_tours', 'vtiger_tourscf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_tours' => 'toursid',
		'vtiger_tourscf'=>'toursid');
	...
	*/
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_tours, vtiger_users,
                ...
                vtiger_tours.toursid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_tours.toursid = $id AND

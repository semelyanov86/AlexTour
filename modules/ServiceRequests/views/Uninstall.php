...
/**
 * Class ServiceRequests_Uninstall_View
 */
class ServiceRequests_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_servicerequestscf table
        echo "&nbsp;&nbsp;- Delete vtiger_servicerequestscf table.";
        $result = $adb->pquery("DROP TABLE vtiger_servicerequestscf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_servicerequests table
        echo "&nbsp;&nbsp;- Delete vtiger_servicerequests table.";
        $result = $adb->pquery("DROP TABLE vtiger_servicerequests");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }

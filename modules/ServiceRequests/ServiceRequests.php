...
class ServiceRequests extends Vtiger_CRMEntity {
    var $db;
	var $table_name = 'vtiger_servicerequests';
	var $table_index= 'servicerequestsid';
	var $related_tables = Array ('vtiger_servicerequestscf' => Array ( 'servicerequestsid', 'vtiger_servicerequests', 'servicerequestsid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_servicerequestscf', 'servicerequestsid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_servicerequests', 'vtiger_servicerequestscf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_servicerequests' => 'servicerequestsid',
		'vtiger_servicerequestscf'=>'servicerequestsid');
	...
	var $list_fields = Array (
		...
		'Name' => Array('servicerequests', 'name'),
	...
	*/
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_servicerequests, vtiger_users,
                ...
                vtiger_servicerequests.servicerequestsid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_servicerequests.servicerequestsid = $id AND

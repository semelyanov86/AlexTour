...
/**
 * Class ServiceRequests_Module_Model
 */
class ServiceRequests_Module_Model extends Vtiger_Module_Model
{
    /**
     * @return array
     */
    function getSettingLinks()
    {
        ...
        $settingsLinks[] = array(
            ...
            'linklabel' => 'Uninstall',
            'linkurl' => 'index.php?module=ServiceRequests&parent=Settings&view=Uninstall',
            'linkicon' => ''
        );

...
/**
 * Class Cities_Uninstall_View
 */
class Cities_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_citiescf table
        echo "&nbsp;&nbsp;- Delete vtiger_citiescf table.";
        $result = $adb->pquery("DROP TABLE vtiger_citiescf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_cities table
        echo "&nbsp;&nbsp;- Delete vtiger_cities table.";
        $result = $adb->pquery("DROP TABLE vtiger_cities");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }

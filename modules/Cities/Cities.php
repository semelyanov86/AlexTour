...
class Cities extends Vtiger_CRMEntity {
    var $db;
	var $table_name = 'vtiger_cities';
	var $table_index= 'citiesid';
	var $related_tables = Array ('vtiger_citiescf' => Array ( 'citiesid', 'vtiger_cities', 'citiesid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_citiescf', 'citiesid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_cities', 'vtiger_citiescf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_cities' => 'citiesid',
		'vtiger_citiescf'=>'citiesid');
	...
	*/
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_cities, vtiger_users,
                ...
                vtiger_cities.citiesid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_cities.citiesid = $id AND

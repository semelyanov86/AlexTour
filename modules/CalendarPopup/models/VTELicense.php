...
class CalendarPopup_VTELicense_Model
{
    public $module = "";
    ...
    public function validate()
    {
        ...
        global $adb;
        $adb->pquery("DELETE FROM `vte_modules` WHERE module=?;", array("CalendarPopup"));
        $adb->pquery("INSERT INTO `vte_modules` (`module`, `valid`) VALUES (?, ?);", array("CalendarPopup", "0"));
        return false;
    }

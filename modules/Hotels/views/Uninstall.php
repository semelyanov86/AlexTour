...
/**
 * Class Hotels_Uninstall_View
 */
class Hotels_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_hotelscf table
        echo "&nbsp;&nbsp;- Delete vtiger_hotelscf table.";
        $result = $adb->pquery("DROP TABLE vtiger_hotelscf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_hotels table
        echo "&nbsp;&nbsp;- Delete vtiger_hotels table.";
        $result = $adb->pquery("DROP TABLE vtiger_hotels");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }

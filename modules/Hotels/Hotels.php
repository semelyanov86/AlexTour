...
class Hotels extends Vtiger_CRMEntity {
    var $db;
	var $table_name = 'vtiger_hotels';
	var $table_index= 'hotelsid';
	var $related_tables = Array ('vtiger_hotelscf' => Array ( 'hotelsid', 'vtiger_hotels', 'hotelsid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_hotelscf', 'hotelsid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_hotels', 'vtiger_hotelscf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_hotels' => 'hotelsid',
		'vtiger_hotelscf'=>'hotelsid');
	...
	*/
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_hotels, vtiger_users,
                ...
                vtiger_hotels.hotelsid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_hotels.hotelsid = $id AND

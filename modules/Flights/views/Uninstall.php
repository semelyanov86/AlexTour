...
/**
 * Class Flights_Uninstall_View
 */
class Flights_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_flightscf table
        echo "&nbsp;&nbsp;- Delete vtiger_flightscf table.";
        $result = $adb->pquery("DROP TABLE vtiger_flightscf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_flights table
        echo "&nbsp;&nbsp;- Delete vtiger_flights table.";
        $result = $adb->pquery("DROP TABLE vtiger_flights");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }

...
/**
 * Class Movings_Uninstall_View
 */
class Movings_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_movingscf table
        echo "&nbsp;&nbsp;- Delete vtiger_movingscf table.";
        $result = $adb->pquery("DROP TABLE vtiger_movingscf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_movings table
        echo "&nbsp;&nbsp;- Delete vtiger_movings table.";
        $result = $adb->pquery("DROP TABLE vtiger_movings");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }

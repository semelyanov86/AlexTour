...
class Movings extends Vtiger_CRMEntity {
    var $db;
	var $table_name = 'vtiger_movings';
	var $table_index= 'movingsid';
	var $related_tables = Array ('vtiger_movingscf' => Array ( 'movingsid', 'vtiger_movings', 'movingsid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_movingscf', 'movingsid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_movings', 'vtiger_movingscf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_movings' => 'movingsid',
		'vtiger_movingscf'=>'movingsid');
	...
	*/
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_movings, vtiger_users,
                ...
                vtiger_movings.movingsid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_movings.movingsid = $id AND

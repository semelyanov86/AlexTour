...
/**
 * Class HotelArrivals_Module_Model
 */
class HotelArrivals_Module_Model extends Vtiger_Module_Model
{
    /**
     * @return array
     */
    function getSettingLinks()
    {
        ...
        $settingsLinks[] = array(
            ...
            'linklabel' => 'Uninstall',
            'linkurl' => 'index.php?module=HotelArrivals&parent=Settings&view=Uninstall',
            'linkicon' => ''
        );

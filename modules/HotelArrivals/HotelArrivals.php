...
class HotelArrivals extends Vtiger_CRMEntity {
    var $db;
	var $table_name = 'vtiger_hotelarrivals';
	var $table_index= 'hotelarrivalsid';
	var $related_tables = Array ('vtiger_hotelarrivalscf' => Array ( 'hotelarrivalsid', 'vtiger_hotelarrivals', 'hotelarrivalsid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_hotelarrivalscf', 'hotelarrivalsid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_hotelarrivals', 'vtiger_hotelarrivalscf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_hotelarrivals' => 'hotelarrivalsid',
		'vtiger_hotelarrivalscf'=>'hotelarrivalsid');
	...
	*/
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_hotelarrivals, vtiger_users,
                ...
                vtiger_hotelarrivals.hotelarrivalsid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_hotelarrivals.hotelarrivalsid = $id AND

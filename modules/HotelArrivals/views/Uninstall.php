...
/**
 * Class HotelArrivals_Uninstall_View
 */
class HotelArrivals_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_hotelarrivalscf table
        echo "&nbsp;&nbsp;- Delete vtiger_hotelarrivalscf table.";
        $result = $adb->pquery("DROP TABLE vtiger_hotelarrivalscf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_hotelarrivals table
        echo "&nbsp;&nbsp;- Delete vtiger_hotelarrivals table.";
        $result = $adb->pquery("DROP TABLE vtiger_hotelarrivals");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }

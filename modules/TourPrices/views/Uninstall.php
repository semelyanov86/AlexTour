...
/**
 * Class TourPrices_Uninstall_View
 */
class TourPrices_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_tourpricescf table
        echo "&nbsp;&nbsp;- Delete vtiger_tourpricescf table.";
        $result = $adb->pquery("DROP TABLE vtiger_tourpricescf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_tourprices table
        echo "&nbsp;&nbsp;- Delete vtiger_tourprices table.";
        $result = $adb->pquery("DROP TABLE vtiger_tourprices");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }

...
/**
 * Class TourPrices_Module_Model
 */
class TourPrices_Module_Model extends Vtiger_Module_Model
{
    /**
     * @return array
     */
    function getSettingLinks()
    {
        ...
        $settingsLinks[] = array(
            ...
            'linklabel' => 'Uninstall',
            'linkurl' => 'index.php?module=TourPrices&parent=Settings&view=Uninstall',
            'linkicon' => ''
        );

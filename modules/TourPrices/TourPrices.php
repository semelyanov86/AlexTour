...
class TourPrices extends Vtiger_CRMEntity {
    var $db;
	var $table_name = 'vtiger_tourprices';
	var $table_index= 'tourpricesid';
	var $related_tables = Array ('vtiger_tourpricescf' => Array ( 'tourpricesid', 'vtiger_tourprices', 'tourpricesid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_tourpricescf', 'tourpricesid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_tourprices', 'vtiger_tourpricescf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_tourprices' => 'tourpricesid',
		'vtiger_tourpricescf'=>'tourpricesid');
	...
	*/
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_tourprices, vtiger_users,
                ...
                vtiger_tourprices.tourpricesid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_tourprices.tourpricesid = $id AND
